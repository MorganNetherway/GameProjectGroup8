...
rooms = {
    ...
    "room_14": {
        ...
        "description": """Due to the appearance and ferocity of the beast, everyone forgets the fact that the Minotaur itself is half human. Humans crave wealth and power, every being that the half bull half man has devoured, all their personal possessions and gold have been stored as a trophy cabinet in the Labyrinth. King Minos himself has not forgotten to appease his half son by ladening the room with the finest antiquities fit for the entrance room of Dionysus himself. The room has a light supply and the reflection is blinding, beware traveller do not touch the monsters riches, or be prepared to face the consequences.""",
        "items": None,
        "action": None
    }
}
...
def gate_1():
    print("You are at gate_1")
def gate_2():
    print("You are at gate_2")
def gate_3():
    print("You are at gate_3")
def gate_4():
